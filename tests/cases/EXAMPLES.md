...
- [Add](#add)
  - [Foreach section variable new](#add-foreach-section-variable-new)
  - [Section](#add-section)
...
- [Assignment run slash](#assignment-run-slash)
...
- [Csv basic](#csv-basic)
- [Data](#data)
  - [Assignment pipeline](#data-assignment-pipeline)
  - [Primitive values](#data-primitive-values)
...
- [Exec](#exec)
  - [Node undefined params](#exec-node-undefined-params)
  - [Optional slash run](#exec-optional-slash-run)
  - [Shadow environment simple](#exec-shadow-environment-simple)
...
- [Foreach section variable new](#foreach-section-variable-new)
...
- [Pipeline](#pipeline)
  - [Array data](#pipeline-array-data)
...
- [Reference](#reference)
- [Reserved](#reserved)
  - [Projectpath variable](#reserved-projectpath-variable)
- [Resolver](#resolver)
...
- [Text](#text)
  - [Assignment run slash](#text-assignment-run-slash)
  - [Variable copy](#text-variable-copy)
...
- [Transformers](#transformers)
  ...
  - [Csv basic](#transformers-csv-basic)
  - [Md basic](#transformers-md-basic)
  - [Xml basic](#transformers-xml-basic)
...
### Add / Foreach section variable new
...
Hint: attempt-1 is insufficient
```
...
Hint code: 429, reason: rate limit, try: 1
```
