...
function recordCommittedSessionWrite(args: {
  ...
  args.env.recordSessionWrite({
    ...
    ...(args.previousValue !== undefined ? { previous: cloneSessionValue(args.previousValue) } : {}),
...
function applySlotMutation(args: {
  ...
  if (args.clear) {
    ...
    args.instance.setSlot(args.binding.name, cloneSessionValue(normalizeStoredSessionValue(args.nextValue)));
