...
async function run() {
  ...
  for (const file of files) {
    ...
    try {
      ...
      // Save AST as JSON
      fs.writeFileSync(
        path.join('/Users/adam/dev/meld/meld-ast-comparison/specific-cases', '3.3.0', `${basename}-ast.json`),
      ...
      fs.writeFileSync(
        path.join('/Users/adam/dev/meld/meld-ast-comparison/specific-cases', '3.3.0', `${basename}-error.log`),
        error.toString()
      );
    }
  }
