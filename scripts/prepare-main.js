...
/**
 * This script prepares the main branch as a clean version of the dev branch
 * It removes development directories and files to create a clean public-facing version
 */
...
try {
  git('add .');
  execSync('git commit -m "Update main branch: Remove development files"', { stdio: 'inherit' });
} catch (e) {
