...
if (testFast) {
  ...
  console.log('   Skipping slowest tests: imports/edge-cases, cli/absolute-paths, import resolver suites, shadow cleanup, python venv manager, shell-commands-parallel, heredoc e2e');
