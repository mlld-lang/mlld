...
describe('text-assignment-run-1 directive', () => {
  it('should parse correctly', () => {
    const directive = `@text result = @run [echo "Command output"]`;
  ...
  "values": {
    ...
    "content": [
      {
        "type": "string",
        "value": "@run [echo \"Command output\"]"
      }
    ]
  },
  "raw": {
    "identifier": "result",
    "content": "@run [echo \"Command output\"]"
  },
  "meta": {
    "sourceType": "literal"
  }
