...
describe('run-exec-parameters-1 directive', () => {
  it('should parse correctly', () => {
    const directive = `@exec greetCommand(param) = @run [echo "Hello, {{param}}"]`;
  ...
  "values": {
    ...
    "content": [
      {
        "type": "string",
        "value": "@run [echo \"Hello, {{param}}\"]"
      }
    ]
  },
  "raw": {
    "identifier": "",
    "content": "@run [echo \"Hello, {{param}}\"]"
  },
  "meta": {
    "sourceType": "literal"
  }
