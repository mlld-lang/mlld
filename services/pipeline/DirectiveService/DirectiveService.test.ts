...
import { TextVariable, DataVariable, VariableType } from '@core/types/variables';
import { ErrorSeverity, MeldError } from '@core/errors/MeldError';
import { createTextDirective, createDataDirective, createImportDirective } from '@tests/utils/testFactories';
import { ResolutionContextFactory } from '@services/resolution/ResolutionService/ResolutionContextFactory';
import type { DirectiveProcessingContext, ExecutionContext } from '@core/types/index';
