...
import type { DirectiveResult, StateChanges } from '@core/directives/DirectiveHandler.js';
...
import { SourceLocation as SyntaxSourceLocation, JsonValue } from '@core/types/common.js';
import { VariableOrigin, VariableType, VariableMetadata, IPathVariable, CommandVariable, TextVariable, DataVariable, MeldVariable, VariableDefinition } from '@core/types/variables.js';
...
import { MeldPath, PathContentType, ValidatedResourcePath } from '@core/types/paths.js';
import type { StateServiceLike } from '@core/shared-service-types.js';
import { MeldResolutionError, MeldFileNotFoundError, MeldError } from '@core/errors/index.js';
